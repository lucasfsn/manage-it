...
public interface TaskService {
    ...
    TaskDetailsResponseDto createAndAddTaskToProject(User owner, UUID projectId, CreateTaskRequest createTaskRequest);

    void deleteTask(User user, UUID taskId, UUID projectId);

    TaskResponseDto updateTask(User updater, UUID taskId, UUID projectId, UpdateTaskRequest request);
